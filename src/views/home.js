...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Home - Cynx's Values</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Home - Cynx's Values" />
        <meta
      ...
      <div className="home-footer">
        <footer className="home-container07">
          <img
            alt="image"
          ...
          <div className="home-container08">
            ...
            <span className="home-text09">Careers</span>
            <span className="home-text10">Help</span>
            <span className="home-text11">Privacy Policy</span>
          </div>
          <div className="home-divider"></div>
          <div className="home-container09">
            <span className="home-text12 body2">
